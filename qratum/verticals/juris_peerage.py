...
class JurisPeerageModule(VerticalModuleBase):
    ...
    def _determine_heirship(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not title_context.get("title_created"):
            ...
            determination.reasoning.append("→ NO TITLE EXISTS WITHOUT FORMAL CREATION (doctrine)")
        ...
        determination.reasoning.append("→ CROWN PREROGATIVE & PARLIAMENTARY SUPREMACY:")
        determination.reasoning.append("  Modern peerage claims are NON-JUSTICIABLE in courts")
        determination.reasoning.append("  Any claim requires Crown petition or Act of Parliament")
    ...
    def _analyze_title_succession(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        analysis = {
            ...
            "eligible_heirs": self._identify_eligible_heirs(
                title_data, parameters.get("proven_lineage")
            ),
            "succession_order": [],
            "legal_constraints": [],
        }
    ...
    def _evaluate_attainder_effects(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        effects["legal_effects"].append("Blood corrupted: title cannot pass through attainted line")
        effects["legal_effects"].append("Heirs of attainted person have NO claim")
    ...
    def _assess_cadet_branch_rights(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        assessment["reasoning"].append("Under primogeniture, title passes to senior (eldest) line")
        assessment["reasoning"].append("Cadet branches (younger sons, junior lines) are excluded")
        assessment["reasoning"].append("No claim exists regardless of descent proximity")
        assessment["reasoning"].append("This is fundamental to English succession law")
    ...
    def _determine_justiciability(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        justiciability["constitutional_basis"].append("Parliamentary supremacy (1689+)")
        justiciability["constitutional_basis"].append(
    ...
    def _identify_eligible_heirs(
        self, title_data: Dict[str, Any], proven_lineage: Optional[Dict[str, Any]]
    ) -> List[str]:
