...
class GlobalSeed:
    ...
    def derive_rank_seed(
        self, rank: int, method: SeedDerivationMethod = SeedDerivationMethod.HASH_CHAIN
    ) -> int:
        """
...
class SeedManager:
    ...
    def generate_epoch_seed(self, epoch: ExecutionEpoch) -> GlobalSeed:
        ...
        global_seed = GlobalSeed(value=epoch_seed_value, epoch=epoch, timestamp=time.time())
...
class ExecutionOrder:
    ...
    operation_log: List[Tuple[int, str, int]] = field(
        default_factory=list
    )  # (global_id, op_name, rank)
...
class GlobalStateManager:
    ...
    def checkpoint_state(self, checkpoint_name: str) -> Dict:
        ...
        state = {
            ...
            "rank_info": {"num_ranks": self.num_ranks, "rank_id": self.rank_id},
        }
