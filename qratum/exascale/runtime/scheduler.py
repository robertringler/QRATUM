...
class GPUResource:
    ...
    def free_memory(self, size_gb: float) -> None:
        """Free GPU memory"""
        self.memory_available_gb = min(self.memory_available_gb + size_gb, self.memory_total_gb)
...
class DeterministicScheduler:
    ...
    def execute_ready_kernels(self) -> List[int]:
        ...
        queue_keys = sorted(self.kernel_queues.keys(), key=lambda k: (k[0], k[1].value))
    ...
    def get_scheduler_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "gpu_utilization": {
                gpu_id: resource.sm_utilization for gpu_id, resource in self.gpu_resources.items()
            },
        }
