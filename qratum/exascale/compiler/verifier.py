...
class BinaryArtifact:
    ...
    def verify_against(self, reference: "BinaryArtifact") -> bool:
        ...
        return self.merkle_hash == reference.merkle_hash and self.size_bytes == reference.size_bytes
...
class CrossNodeVerifier:
    ...
    def verify_with_merkle_tree(
        ...
        mismatched = [node_id for node_id, root in merkle_roots.items() if root != majority_root]
    ...
    def full_verification(
        ...
        if artifacts_by_node:
            ...
            if first_artifacts:
                ...
                all_first_artifacts = [
                    artifacts[0] for artifacts in artifacts_by_node.values() if artifacts
                ]
        ...
        if required_level == VerificationLevel.L2_ZK_PROOF:
            all_artifacts = [
                artifact for artifacts in artifacts_by_node.values() for artifact in artifacts
            ]
