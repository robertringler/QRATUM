...
class CipherSuite(Enum):
    ...
    X25519_KYBER1024_ECDSA384_CHACHA20POLY1305_SHA384 = (
        "X25519-Kyber1024-ECDSA384-ChaCha20Poly1305-SHA384"
    )
...
class QDRTLS:
    ...
    def create_server_transport(self, client_node_id: str) -> "SecureTransport":
        """
    ...
    def create_client_transport(self, server_node_id: str) -> "SecureTransport":
        """
...
class SecureTransport:
    ...
    def _client_handshake(
        ...
        self._send_handshake_message(
            HandshakeState.CLIENT_KEY_EXCHANGE, kyber_ciphertext.ciphertext
        )

        # ClientFinished
        self._send_handshake_message(HandshakeState.CLIENT_FINISHED, b"client_finished")

    def _server_handshake(self, client_certificate: Optional[TLSCertificate]):
        ...
        # ServerKeyExchange
        self._send_handshake_message(
            HandshakeState.SERVER_KEY_EXCHANGE, server_kyber_keypair.public_key
        )
    ...
    def _derive_session_keys(self):
        ...
        master_secret_input = (
            self.session_id.encode() + self.local_node_id.encode() + self.remote_node_id.encode()
        )
