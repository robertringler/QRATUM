...
Generated: 2026-01-14T03:43:56.928736
...
| Model | Primary Metric | Secondary Metric | Latency (ms) | Stability | Deterministic |
|-------|---------------|------------------|--------------|-----------|---------------|
| slt | 0.9910 ± 0.0020 | 0.9910 ± 0.0020 | 15.47 | 0.998 | ❌ |
...
|------|------|-------|---------------------|
| 1 | tabular-cls | logreg | 98.953980 |
| 2 | tabular-cls | mlp | 78.321422 |
| 3 | tabular-cls | rf | 2.581437 |
| 4 | tabular-cls | slt | 1.619552 |
| 5 | text-cls | slt | 0.983723 |
