...
class TestGlobalFrameCache:
    ...
    def test_cache_frame_global(self):
        ...
        from quasic_viz.services.qubic_render.frame_cache import FRAME_HISTORY, cache_frame
    ...
    def test_get_frame_at_global(self):
        ...
        from quasic_viz.services.qubic_render.frame_cache import cache_frame, get_frame_at
