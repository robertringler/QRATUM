...
def main():
    ...
    print(f"  (Complete interrogation text with all 20 questions)")
    print()
    ...
    with open(exec_summary_file, 'w') as f:
        ...
        f.write("OVERVIEW\n")
        f.write("-" * 80 + "\n")
        f.write(f"This interrogation used the QRATUM-ASI MEGA PROMPT framework to query\n")
        f.write(f"{len(orchestrator.adapters)} AI models with {len(system.questions)} standardized questions about\n")
        f.write(f"Artificial Superintelligence safety across 10 critical categories.\n\n")
