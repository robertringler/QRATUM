...
class TestZKProofGenerator:
    ...
    def test_generate_proof_deterministic(self):
        ...
        proof1 = gen1.generate_proof(
            b"prev", b"next", b"witness", TransitionType.TXO_EXECUTION
        )
        proof2 = gen2.generate_proof(
            b"prev", b"next", b"witness", TransitionType.TXO_EXECUTION
        )
...
class TestConvenienceFunctions:
    ...
    def test_verify_state_transition(self):
        ...
        proof = gen.generate_proof(
            prev_state, next_state, b"", TransitionType.TXO_EXECUTION
        )
        
        is_valid, message = verify_state_transition(
            prev_state, next_state, proof, "Z1", 1
        )
