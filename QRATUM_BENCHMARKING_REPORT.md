...
2. ⏳ Optimize memory usage (chunking)
3. ⏳ Implement parallel processing (multiprocessing)
...
3. ⏳ Population-scale analysis (10K+ samples)
4. ⏳ Benchmark publication in Nature Methods
