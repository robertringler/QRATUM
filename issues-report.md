...
1319	      	[ ] invalid-syntax
 ...
 304	N806  	[ ] non-lowercase-variable-in-function
 ...
 125	F821  	[ ] undefined-name
  ...
  26	SIM108	[ ] if-else-block-instead-of-if-exp
  ...
  10	I001  	[*] unsorted-imports
   ...
   1	B004  	[ ] unreliable-callable-check
...
Found 3926 errors.
[*] 10 fixable with the `--fix` option (1545 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
