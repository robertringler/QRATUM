...
1008	      	[ ] invalid-syntax
 ...
 373	UP045 	[ ] non-pep604-annotation-optional
 325	N999  	[ ] invalid-module-name
...
Found 4328 errors.
[*] 13 fixable with the `--fix` option (1739 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
