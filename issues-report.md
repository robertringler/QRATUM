...
Found 2015 errors.
[*] 10 fixable with the `--fix` option (1269 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
