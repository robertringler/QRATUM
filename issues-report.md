...
### Ruff Linting
1000	      	[ ] invalid-syntax
 952	W293  	[ ] blank-line-with-whitespace
 340	N806  	[ ] non-lowercase-variable-in-function
 289	UP045 	[ ] non-pep604-annotation-optional
 195	UP006 	[ ] non-pep585-annotation
 133	F841  	[ ] unused-variable
 125	F821  	[ ] undefined-name
  85	E402  	[ ] module-import-not-at-top-of-file
  82	SIM102	[ ] collapsible-if
  72	B007  	[ ] unused-loop-control-variable
  60	N803  	[ ] invalid-argument-name
  38	F401  	[ ] unused-import
  29	W291  	[ ] trailing-whitespace
  28	B904  	[ ] raise-without-from-inside-except
  27	SIM108	[ ] if-else-block-instead-of-if-exp
...
Found 3646 errors.
[*] 13 fixable with the `--fix` option (1539 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
