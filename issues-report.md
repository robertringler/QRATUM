...
Found 4244 errors.
[*] 13 fixable with the `--fix` option (1669 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
