...
1319	      	[ ] invalid-syntax
 949	W293  	[ ] blank-line-with-whitespace
 341	UP045 	[ ] non-pep604-annotation-optional
 315	N806  	[ ] non-lowercase-variable-in-function
 310	N999  	[ ] invalid-module-name
 249	UP006 	[ ] non-pep585-annotation
 129	F841  	[ ] unused-variable
 125	F821  	[ ] undefined-name
  ...
  10	UP031 	[ ] printf-string-formatting
   ...
   1	UP007 	[ ] non-pep604-annotation-union
Found 4344 errors.
[*] 10 fixable with the `--fix` option (1638 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
