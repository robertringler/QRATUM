...
1353	N806  	[ ] non-lowercase-variable-in-function
 ...
 440	UP045 	[ ] non-pep604-annotation-optional
 434	UP006 	[ ] non-pep585-annotation
 341	N999  	[ ] invalid-module-name
...
Found 4753 errors.
[*] 14 fixable with the `--fix` option (2095 hidden fixes can be enabled with the `--unsafe-fixes` option).
### Type Checking (mypy)
