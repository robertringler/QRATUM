...
% ============================================================
%  Chapter 10 — External Informational Layer (placeholder)
% ============================================================
\chapter{CIIR as External Informational Layer on Quantum Systems}
\label{ch:external-layer}

\begin{center}
\emph{[This chapter is under preparation and will be provided separately.]}
\end{center}

\noindent
This chapter will extend the CIIR framework to operate as an external
informational layer interfacing with physical quantum systems.  Topics
to be covered include:
\begin{itemize}[nosep]
  \item Coupling of the constraint manifold $(\CM, g, \kappa)$ to
        laboratory quantum hardware.
  \item CIIR-augmented quantum error correction via constraint-induced
        syndrome decoding.
  \item Information-theoretic bounds on interface fidelity under
        decoherence.
  \item Experimental signatures distinguishing CIIR predictions from
        standard quantum mechanics.
\end{itemize}

% ============================================================
%  Chapter 11 — Computational Reality System (placeholder)
% ============================================================
...
\noindent
The Computational Reality System (CRS) translates the CIIR formalism
into executable numerical and symbolic pipelines.  Planned sections
include:
\begin{itemize}[nosep]
  \item Tensorised representation of constraint operators and Lindblad
        generators.
  \item Numerical integration of the CIIR master equation (adaptive
        Runge--Kutta and Krylov methods).
  \item QuASIM runtime integration and QRATUM system hooks.
  \item Benchmark results on standard open-quantum-system test suites.
\end{itemize}
