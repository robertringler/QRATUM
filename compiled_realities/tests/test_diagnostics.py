...
from compiled_realities.diagnostics.chi_effective import compute_chi_effective, compute_chi_statistics
from compiled_realities.diagnostics.s_lab import compute_s_lab, check_s_lab_significance
