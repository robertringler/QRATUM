...
class MotifTracker:
    ...
    def get_render_data(self) -> dict[str, Any]:
        ...
        for motif in self.state.active_motifs:
            ...
            if category == "tactical" and self.state.show_tactical or category == "strategic" and self.state.show_strategic or category == "conceptual" and self.state.show_conceptual or category == "novel" and self.state.show_novel:
