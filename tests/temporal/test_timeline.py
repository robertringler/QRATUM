...
from qratum.temporal import (StateChain, TemporalCoordinate, TemporalState,
...
class TestTimelineManager:
    ...
    def test_branch_timeline(self):
        ...
        for i in range(10):
            ...
            parent_hash = parent.chain.states[-1].coordinate.state_hash if parent.chain.states else None
            state = TemporalState(
                coordinate=coord,
                data=i,
