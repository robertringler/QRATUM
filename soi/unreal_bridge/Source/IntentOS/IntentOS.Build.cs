// IntentOS.Build.cs
// QRATUM IntentOS — UE5 module (renamed from SoiGame)
// Rust telemetry core linkage preserved; build will set SOI_RUST_AVAILABLE=1 if the Rust
// shared library is present on disk. Compatibility mapping: SOIGAME_API -> INTENTOS_API
...
public class IntentOS : ModuleRules
{
    public IntentOS(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        // Compatibility: map old export macro to new module API to avoid changing UCLASS tokens
        PublicDefinitions.Add("SOIGAME_API=INTENTOS_API");
